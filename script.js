...
function validation(){
    ...
    document.getElementById("grossinfo").style.display= a ? "none" : "inline";
    document.getElementById("extrainfo").style.display= b ? "none" : "inline";
    document.getElementById("dedinfo").style.display= c ? "none" : "inline";
    document.getElementById("ageinfo").style.display= age !='none' ? "none" : "inline";
...
document.getElementById("deductions").addEventListener("click",()=>{
    document.getElementById("dedinfo").style.display= "none";
});
